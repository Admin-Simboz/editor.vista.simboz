            ...
            <div class="font" v-if="showFont">
                ...
                <Row :gutter="12">
                    ...
                    <InputNumber v-model="fontAttr.lineHeight" @on-change="(value) => changeCommon('lineHeight', value)"
                        :step="0.1" :append="$t('attributes.line_height')"></InputNumber>
                    </Col>
                    <Col flex="1">
            ...
            <div class="font-background-color" v-if="showBackground">
                ...
                <div class="custom-slider">
                    ...
                    <div class="slider-component-cyan">
                        <input class="slider" type="range" min="0" max="100" @change="changeBackgroundColorFont"
                            v-model.number="c" show-input />
                    </div>
                    <div class="slider-component">
            ...
            <div v-if="showColor">
                ...
                <div class="flex-view">
                    <div class="flex-item" id="angel">
                        ...
                        <div class="content slider-box">
                            <Slider v-model="baseAttr.angle" :max="360" @on-input="(value) => changeCommon('angle', value)">
                            </Slider>
                        </div>
                    </div>
                </div>
                <div class="flex-view">
                    <div class="flex-item" id="angel">
                        ...
                        <div class="content slider-box">
                            <Slider v-model="baseAttr.opacity" @on-input="(value) => changeCommon('opacity', value)">
                            </Slider>
                        </div>
                    </div>
                </div>
                ...
                <div class="ivu-col__box">
                    <div class="content">
                        ...
                        <div class="custom-slider">
                            ...
                            <div class="slider-component-cyan">
                                <input class="slider" type="range" min="0" max="100" @change="changeStrokeColor"
                ...
                <Row :gutter="12">
                    ...
                    <div class="ivu-col__box">
                        <InputNumber v-model="baseAttr.strokeWidth"
                            @on-change="(value) => changeCommon('strokeWidth', value)" :append="$t('width')" :min="0">
                        </InputNumber>
                    </div>
                    </Col>
                </Row>
            ...
            <div v-if="showShadow">
                    ...
                    <div class="content">
                        <div class="cmyk-inputs">
                            <ColorPicker v-model="baseAttr.shadow.color"
                                @on-change="(value) => changeCommon('color', value)" basic />
                        </div>
                        ...
                        <div class="custom-slider">
                            ...
                            <div class="slider-component-cyan">
                                <input class="slider" type="range" min="0" max="100" @change="changeShadowColor"
                ...
                <Row :gutter="12">
                    ...
                    <InputNumber v-model="baseAttr.shadow.blur" :defaultValue="0"
                        @on-change="(value) => changeShadow('blur', value)" :append="$t('attributes.blur')" :min="0">
                    </InputNumber>
                    </Col>
                </Row>
                ...
                <Row :gutter="12">
                    ...
                    <InputNumber v-model="baseAttr.shadow.offsetX" :defaultValue="0"
                        @on-change="(value) => changeShadow('offsetX', value)" :append="$t('attributes.offset_x')">
                    </InputNumber>
                    </Col>
                    <Col flex="1">
                    <InputNumber v-model="baseAttr.shadow.offsetY" :defaultValue="0"
                        @on-change="(value) => changeShadow('offsetY', value)" :append="$t('attributes.offset_y')">
                    </InputNumber>
                    </Col>
                </Row>
